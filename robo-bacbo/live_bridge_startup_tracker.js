...
const PYTHON_STARTUP_MARKERS = Object.freeze([
    ...
    ['POPUPS_CHECK_DONE', /^BRASIL_DA_SORTE_POPUPS_CHECK_DONE=true$/],
    ['SESSION_PROBE_DONE', /^BRASIL_DA_SORTE_SESSION_PROBE_DONE=/],
    ['LOGIN_BUTTON_FOUND', /^BRASIL_DA_SORTE_LOGIN_BUTTON_FOUND=/],
    ...
    ['PLAY_TRANSITION_READY', /^BRASIL_DA_SORTE_PLAY_TRANSITION_READY_MS=/],
    ['PLAY_TRANSITION_WAIT_EXHAUSTED', /^BRASIL_DA_SORTE_PLAY_TRANSITION_WAIT_EXHAUSTED_MS=/],
