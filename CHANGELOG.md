...
### Fixed
- BUG-028: a espera do Auto-Trader deixa de tratar 15 segundos após `Resolved` como prova de janela perdida. A ordem permanece vinculada ao mesmo `coletor_seq`, só pode executar em `stage=Betting` fresco e expira imediatamente se outro resultado for resolvido, se a continuidade cair ou se o executor ficar indisponível.
